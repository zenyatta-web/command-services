...
func (x *HelloWordResponse) Reset() {
	*x = HelloWordResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *HelloWordResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloWordResponse) ProtoMessage() {}

func (x *HelloWordResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_hello_hello_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloWordResponse.ProtoReflect.Descriptor instead.
func (*HelloWordResponse) Descriptor() ([]byte, []int) {
	return file_proto_hello_hello_proto_rawDescGZIP(), []int{1}
}

func (x *HelloWordResponse) GetHello() string {
	if x != nil {
		return x.Hello
	}
	return ""
...
var file_proto_hello_hello_proto_rawDesc = []byte{
	...
	,
...
var file_proto_hello_hello_proto_goTypes = []interface{}{
	...
	(*HelloWordResponse)(nil), // 1: hipstershop.HelloWordResponse
}
var file_proto_hello_hello_proto_depIdxs = []int32{
	0, // 0: hipstershop.Hello.HelloWord:input_type -> hipstershop.Empty
	1, // 1: hipstershop.Hello.HelloWord:output_type -> hipstershop.HelloWordResponse
...
func file_proto_hello_hello_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_hello_hello_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloWordResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
